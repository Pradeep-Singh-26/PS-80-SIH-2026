...
| **Brier Skill Score (BSS)** | **`-0.5064`** | **`-0.2928`** | Skill improvement over climatology (> 0 is skill) |
| **Expected Calibration Error (ECE)** | **`0.1205`** | **`0.0196`** | Weighted average reliability deviation |
| **ROC-AUC (Discrimination)** | **`0.5410`** | **`0.5176`** | Area under ROC curve |
...
|---|---|---|---|---|
| `[0.0, 0.1)` | `0.0510` | `0.0960` | `198` | `51.6%` |
| `[0.1, 0.2)` | `0.1398` | `0.1556` | `90` | `23.4%` |
| `[0.2, 0.3)` | `0.2416` | `0.0769` | `26` | `6.8%` |
| `[0.3, 0.4)` | `0.3557` | `0.1364` | `22` | `5.7%` |
| `[0.4, 0.5)` | `0.4478` | `0.3333` | `9` | `2.3%` |
| `[0.5, 0.6)` | `0.5299` | `0.2500` | `8` | `2.1%` |
| `[0.6, 0.7)` | `0.6488` | `0.0000` | `6` | `1.6%` |
| `[0.7, 0.8)` | `0.7431` | `0.0000` | `7` | `1.8%` |
